...
Brief ambigu
   │
   ▼
Hypothèses explicites écrites (pas dans ta tête)
   │
   ▼
Premier livrable qui teste les hypothèses les plus risquées en premier
   │
   ▼
Retour (réel ou simulé) → confirme ou infirme
   │
   ▼
Ajustement du périmètre, jamais du silence
```
